...
<script>
    ...
    var tableName = "dictionaryWaichuqingqiuYesno";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "waichuqingqiu_yesno_types";
            data["dicName"] = "审核结果";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"waichuqingqiu_yesno_types"}, (res) => {
                if(res.code == 0){
