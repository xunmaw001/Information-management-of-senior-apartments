                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 chuangweiUuidNumberDiv">
                                        <label>床位编号</label>
                                        <input style="width: 450px" id="chuangweiUuidNumber" name="chuangweiUuidNumber" class="form-control"
                                               placeholder="床位编号">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                chuangweiUuidNumber: "required",
                fangjianName: "required",
                yonghuId: "required",
            },
            messages: {
                chuangweiUuidNumber: "床位编号不能为空",
                fangjianName: "所属房间不能为空",
                yonghuId: "使用人不能为空",
            }
        }).form();
    }
    ...
    function getDetails() {
        ...
        if (addchuangwei != null && addchuangwei != "" && addchuangwei != "null") {
            //注册表单验证
            $(validform());
            $("#chuangweiUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#chuangweiUuidNumber").val(ruleForm.chuangweiUuidNumber);
