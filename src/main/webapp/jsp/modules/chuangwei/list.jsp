...
<!--/Pre Loader -->
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="fangjianNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="所属房间" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //床位编号
            var chuangweiUuidNumberCell = document.createElement('td');
            chuangweiUuidNumberCell.innerHTML = item.chuangweiUuidNumber;
            row.appendChild(chuangweiUuidNumberCell);
