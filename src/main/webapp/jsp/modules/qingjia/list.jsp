...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //请假原因
            var qingjiaTextCell = document.createElement('td');
            qingjiaTextCell.innerHTML = item.qingjiaText;
            row.appendChild(qingjiaTextCell);
            ...
            //申请时间
            var qingjiaTimeCell = document.createElement('td');
            qingjiaTimeCell.innerHTML = item.qingjiaTime;
            row.appendChild(qingjiaTimeCell);
    ...
    //查询当前表搜索条件所有列表
            ...
            function qingjiaYesnoTypesShenhe() {
                ...
                data["qingjiaYesnoText"] = $("#qingjiaYesnoText").val();
                    httpJson("qingjia/update", "POST", data, (res) => {
                        if(res.code == 0){
                            alert('审核成功');
                            getDataList();
                        }else{
