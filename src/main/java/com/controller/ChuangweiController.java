    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(chuangwei !=null){
            ...
            BeanUtils.copyProperties( chuangwei , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(chuangwei.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody ChuangweiEntity chuangwei, HttpServletRequest request){
        ...
        if(false)
            ...
            chuangwei.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ChuangweiEntity> queryWrapper = new EntityWrapper<ChuangweiEntity>()
            ...
            .eq("fangjian_name", chuangwei.getFangjianName())
            .eq("yonghu_id", chuangwei.getYonghuId())
            ;
...
//                            chuangweiEntity.setFangjianName(data.get(0));                    //所属房间 要改的
//                            chuangweiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //使用人 要改的
//                            chuangweiEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //床位编号
                        List<ChuangweiEntity> chuangweiEntities_chuangweiUuidNumber = chuangweiService.selectList(new EntityWrapper<ChuangweiEntity>().in("chuangwei_uuid_number", seachFields.get("chuangweiUuidNumber")));
